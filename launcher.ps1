...
# This is the most aggressive fix for the "Could not create SSL/TLS secure channel" error.
# It forces the system to ignore any certificate problems.
...
# Now that defenses are lowered and certificate errors are ignored, we download the .exe.
